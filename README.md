...
I deduce that the way the angular_velocity is created is by simply by subtracting the current rotation by the previous rotation, and multiplying that my delta.
